        ...
        <div className="md:col-span-5">
          <div className="sticky top-32">
            ...
            <h2 className="h-display text-5xl md:text-6xl lg:text-7xl text-ink">
              {faqs.headingLine1} <br />
              <span className="italic text-champagne">{faqs.headingLine2}</span>
            </h2>
          </div>
        </div>
            ...
            {faqs.items.map((f, idx) => {
              ...
              return (
                <li key={f.question} className="border-b border-line">
                  ...
                  >
                    <span className="h-display text-2xl md:text-3xl text-ink group-hover:text-champagne transition-colors">
                      {f.question}
                    </span>
                  ...
                  <div className={`grid transition-all duration-500 ease-out ${isOpen ? 'grid-rows-[1fr] opacity-100 pb-8' : 'grid-rows-[0fr] opacity-0'}`}>
                    <div className="overflow-hidden">
                      <p className="text-muted2 text-base md:text-lg leading-relaxed max-w-2xl pr-8">{f.answer}</p>
                    </div>
                  </div>
                </li>
              );
